...
public class UseDummyAdapter extends Activity {
   ...
   protected  void loadAd(final RelativeLayout layout, final DummyAdapter adapter, final DummyAdapter.Listener listener){
    ...
    protected void reload(final RelativeLayout layout, final DummyAdapter adapter, final DummyAdapter.Listener listener){
